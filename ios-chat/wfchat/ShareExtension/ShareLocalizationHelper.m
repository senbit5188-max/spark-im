    ...
    dispatch_once(&onceToken, ^{
        strings = @{
            ...
            @"zh-Hans": @{
                ...
                @"NotSupportMultiImagesMessage": @"每次只能发送一张。如果您需要一次发送多张，请打开星火选择图片发送。",
                @"Sent": @"已发送",
                @"ViewInWildFire": @"您可以在星火中查看",
                @"NetworkError": @"网络错误",
            ...
            @"zh-Hant": @{
                ...
                @"NotSupportMultiImagesMessage": @"每次只能發送一張。如果您需要一次發送多張，請打開星火選擇圖片發送。",
                @"Sent": @"已發送",
                @"ViewInWildFire": @"您可以在星火中查看",
                @"NetworkError": @"網絡錯誤",
            ...
            @"en": @{
                ...
                @"NotSupportMultiImagesMessage": @"Only one image at a time. If you need to send multiple images, please open SparkChat and select images to send.",
                @"Sent": @"Sent",
                @"ViewInWildFire": @"You can view it in SparkChat",
                ...
                @"PleaseLoginWildFireIM": @"Please login to SparkChat first",
                @"Cancel": @"Cancel",
                @"Confirm": @"Confirm",
            }
        };
