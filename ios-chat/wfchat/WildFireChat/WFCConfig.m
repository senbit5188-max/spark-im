...
NSString *IM_SERVER_HOST = @"109.123.239.207";
...
NSString *APP_SERVER_ADDRESS = @"https://api.telvoro.top";
...
NSString *USER_AGREEMENT_URL = @"https://example.com/user_agreement.html";
